...
const About = ({ language }) => {
  return (
    <article className="flex flex-col-reverse lg:flex-row items-center lg:items-start gap-10 mx-5 bg-white p-10 rounded-xl bg-opacity-0 backdrop-filter backdrop-blur-lg ">
      <div className="flex flex-col items-center place-content-start md:grid grid-cols-6 grid-rows-2 gap-8 [&>p]:text-pretty [&>p]:text-black">
        <img
          ...
          alt="Foto de Alex"
        />
        <p className=" col-span-4 place-content-center font-medium text-md transition bg-white shadow p-8 rounded-xl bg-opacity-90 backdrop-filter backdrop-blur-lg  overflow-hidden hover:opacity-95 hover:scale-[1.05] hover:rotate-1">
          {language === "en"
        ...
        <p className=" col-span-3 place-content-start font-medium text-md transition bg-white shadow p-8 rounded-xl bg-opacity-90 backdrop-filter backdrop-blur-lg  overflow-hidden hover:opacity-95 hover:scale-[1.05] hover:rotate-1">
          {language === "en"
        ...
        <p className=" col-span-3 place-content-center font-medium text-md transition bg-white shadow p-8 rounded-xl bg-opacity-90 backdrop-filter backdrop-blur-lg  overflow-hidden hover:opacity-95 hover:scale-[1.05] hover:rotate-1">
          {language === "en"
