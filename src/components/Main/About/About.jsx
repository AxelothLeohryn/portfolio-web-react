  ...
  return (
    <article className="flex flex-col-reverse lg:flex-row items-center lg:items-start gap-10 mx-5">
      <div className="flex flex-col items-center place-content-start md:grid grid-cols-6 grid-rows-2 gap-4 [&>p]:text-pretty [&>p]:text-gray-400">
        <img
          className="col-span-2 rounded-tr-3xl w-full aspect-square z-20 mt-4 border-4 border-neutral-900 shadow-lg lg:mt-0 transition duration-300 hover:scale-[1.05] hover:rotate-1 hover:shadow-xl"
          src="/about-me.webp"
          alt="Foto de Alex"
        />
        <p className="p-4 col-span-4 h-full place-content-center font-medium text-xl bg-neutral-950 rounded-tl-2xl border border-neutral-800 transition hover:shadow-lg backdrop-filter backdrop-blur-3xl overflow-hidden hover:opacity-95">
          {language === "en"
        ...
        <p className="p-4 col-span-3 h-full place-content-center font-medium text-lg md:text-xl bg-neutral-950 rounded-tr-2xl border border-neutral-800 transition hover:shadow-lg backdrop-filter backdrop-blur-3xl overflow-hidden hover:opacity-95">
          {language === "en"
        ...
        <p className="p-4 col-span-3 h-full place-content-center font-medium text-lg bg-neutral-950 rounded-tl-2xl border border-neutral-800 transition hover:shadow-lg backdrop-filter backdrop-blur-3xl overflow-hidden hover:opacity-95">
          {language === "en"
