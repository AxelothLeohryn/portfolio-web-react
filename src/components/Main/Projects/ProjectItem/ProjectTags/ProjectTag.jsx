...
const ProjectTag = ({ tag }) => {
  ...
  return (
    <span
      className="bg-gray-800 text-slate-100 text-[0.6rem] font-medium inline-flex items-center px-2.5 py-1 rounded-full hover:scale-110 transition cursor-pointer"
      style={style}
