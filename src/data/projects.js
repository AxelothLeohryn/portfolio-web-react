export const projectList = [
  {
    ...
    description:
      "Aplicación web fullstack para la gestión de proyectos y tareas por usuario, inspirada en Trello. Login y registro de usuarios, creación de tableros y listas, asignación de tareas a listas, y funcionalidad drag and drop. Tests de integración con Cypress. Mobile-first y diseño responsive.",
      extraDescription:"Actualmente en fase 2! (añadiendo funcionalidades y mejorando el diseño).",
    accessData: {
        user: "demo@gmail.com",
        password: "Demo123!"
    },
    ...
    tags: ["REACT", "NODEJS", "EXPRESS", "MONGODB", "SASS", "CYPRESS"],
  },
  {
    title: "Diseñador de camisetas - 3D & IA",
    description:
      "Aplicación web fullstack para visualizar diseños de camisetas en 3D y obtener diseños de la IA. Interfaz con colores dinámicos y fluida, adaptada a cualquier dispositivo, con la posibilidad de subir tus propios archivos como logos o texturas. También se pueden generar nuevos logos y texturas empleando el asistente de IA (OpenAI API).",
    accessData: null,
