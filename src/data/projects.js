export const projectListES = [
  ...
  },
  {
    ...
    items: [
      "Inicio de sesión seguro con Clerk.",
      "Creación de reuniones y acceso a funcionalidades de reuniones.",
      "Grabación, compartir pantalla y gestión de participantes.",
      "Diseño responsive y accesible.",
    ],
    accessData: null,
    images: [
      "https://github.com/AxelothLeohryn/zoom_clone/blob/main/docs/readme/images/main-normal.png?raw=true",
      "https://github.com/AxelothLeohryn/zoom_clone/blob/main/docs/readme/images/new.png?raw=true",
      "https://github.com/AxelothLeohryn/zoom_clone/blob/main/docs/readme/images/login.png?raw=true",
      "https://github.com/AxelothLeohryn/zoom_clone/blob/main/docs/readme/images/meeting-normal.png?raw=true",
    ],
    link: "https://al-zoom-clone.onrender.com/",
    github: "https://github.com/AxelothLeohryn/zoom_clone",
